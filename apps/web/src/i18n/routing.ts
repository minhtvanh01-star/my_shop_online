...
export const routing = defineRouting({
  ...
  pathnames: {
    ...
    '/auth/forgot-password': { vi: '/quen-mat-khau', en: '/auth/forgot-password' },
    '/auth/reset-password': { vi: '/dat-lai-mat-khau', en: '/auth/reset-password' },
    '/auth/verify-email': { vi: '/xac-thuc-email', en: '/auth/verify-email' },
