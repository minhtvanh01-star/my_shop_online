...
const SYSTEM_CONFIGS = [
  ...
  { key: 'locale.vi_currency',         value: 'VND',            dataType: 'string',  group: 'general',  description: 'Tiền tệ hiển thị khi ngôn ngữ VI',     isPublic: true  },
  { key: 'locale.en_currency',         value: 'USD',            dataType: 'string',  group: 'general',  description: 'Tiền tệ hiển thị khi ngôn ngữ EN',     isPublic: true  },
  { key: 'admin.dashboard_currency',   value: 'VND',            dataType: 'string',  group: 'general',  description: 'Tiền tệ hiển thị doanh thu dashboard', isPublic: true  },
  { key: 'site.maintenance_mode',      value: 'false',          dataType: 'boolean', group: 'general',  description: 'Chế độ bảo trì',                      isPublic: false },
  { key: 'shipping.flat_fee_usd',      value: '0',              dataType: 'number',  group: 'shipping', description: 'Phí vận chuyển cố định (USD). 0 = miễn phí.', isPublic: true },
  ...
  { key: 'payment.stripe_enabled',     value: 'true',           dataType: 'boolean', group: 'payment',  description: 'Bật/tắt thanh toán Stripe',            isPublic: true  },
  { key: 'payment.vnpay_enabled',      value: 'true',           dataType: 'boolean', group: 'payment',  description: 'Bật/tắt thanh toán VNPay',             isPublic: true  },
  { key: 'payment.cod_enabled',        value: 'true',           dataType: 'boolean', group: 'payment',  description: 'Bật/tắt thanh toán COD',               isPublic: true  },
  { key: 'payment.stripe_locales',     value: 'vi,en',          dataType: 'string',  group: 'payment',  description: 'Locale dùng Stripe',                   isPublic: true  },
  { key: 'payment.vnpay_locales',      value: 'vi',             dataType: 'string',  group: 'payment',  description: 'Locale dùng VNPay',                    isPublic: true  },
  { key: 'payment.cod_locales',        value: 'vi',             dataType: 'string',  group: 'payment',  description: 'Locale dùng COD',                      isPublic: true  },
  { key: 'order.max_items',            value: '50',             dataType: 'number',  group: 'orders',   description: 'Số item tối đa trong 1 đơn hàng',     isPublic: false },
  { key: 'order.return_window_days',   value: '7',              dataType: 'number',  group: 'orders',   description: 'Số ngày đổi/trả sau khi giao',        isPublic: true  },
  { key: 'checkout.default_country',   value: 'VN',             dataType: 'string',  group: 'checkout', description: 'Quốc gia mặc định lúc checkout',       isPublic: true  },
  { key: 'checkout.allowed_countries', value: 'VN,US',          dataType: 'string',  group: 'checkout', description: 'Quốc gia ISO-2, cách nhau bởi dấu phẩy', isPublic: true },
  ...
  { key: 'auth.refresh_token_ttl_d',   value: '7',              dataType: 'number',  group: 'auth',     description: 'Thời hạn refresh token (ngày)',        isPublic: false },
  { key: 'api.rate_limit_max',         value: '200',            dataType: 'number',  group: 'api',      description: 'Số request tối đa trong một cửa sổ',  isPublic: false },
  { key: 'api.rate_limit_window_min',  value: '15',             dataType: 'number',  group: 'api',      description: 'Độ dài cửa sổ rate limit (phút)',      isPublic: false },
];
